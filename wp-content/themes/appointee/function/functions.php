...
function appointee_copyright_customizer($wp_customize) {
    ...
    $wp_customize->add_setting(
            ...
            array(
                'default' => '<p>' . __('<a href="https://wordpress.org">Proudly powered by WordPress</a> | Theme: <a href="https://webriti.com" rel="nofollow">Appointee</a> by Webriti', 'appointee') . '</p>',
    ...
    $wp_customize->add_control(
            'appointment_options[footer_social_media_googleplus_link]',
            array(
                'label' => esc_html__('GooglePlus URL', 'appointee'),
                'section' => 'copyright_social_icon',
                'type' => 'text',
            )
    );
