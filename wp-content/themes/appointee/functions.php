...
if (!function_exists('wp_body_open')) {
 ...
 function appointee_default_data() {
    ...
    return $theme_data = array(
        // general settings
        'footer_copyright_text' =>'<p>' . __('<a href="https://wordpress.org">Proudly powered by WordPress</a> | Theme: <a href="https://webriti.com" rel="nofollow">Appointee</a> by Webriti', 'appointee') . '</p>',
